...
function charChoice() {
  var upCaseChoice = confirm(
    "Would you like an upper case letter in your password?"
  );
  var lowCaseChoice = confirm(
    "Would you like a lower case letter in your password?"
  );
  var numberChoice = confirm("Would you like a number in your password?");
  var specCharChoice = confirm(
    "Would you like a special character in your password?"
  );

  //If statements to string together user choices. Addition assignment used to determine what is assigned to
...
function generatePassword() {
  ...
  //Conditional statement to determine password length
